...
export class AddNftService {
  ...
  AddProduct(model: any, idUser: string): any {
    console.log(model);
    ...
    return this.http.post<any>(`${this.UrlAddProduct}/${idUser}/nfts`, JSON.stringify(model), httpOptions)
      .pipe(map(product => {
          if (product) {
